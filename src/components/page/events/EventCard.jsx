...
export default function EventCard({ card, theme, onEdit, onDelete, onView }) {
  ...
  return (
    <Grid item xs={12} sm={6} md={4}>
      ...
      >
        {/* منطقة عرض الصورة أو البديل في حال غيابها */}
        ...
        <CardContent sx={{ p: 2.5, display: "flex", flexDirection: "column", flexGrow: 1 }}>
          ...
          >
            ...
            <Box sx={{ flex: 1, display: "flex", justifyContent: "center", borderRight: "1px solid rgba(0,0,0,0.06)", borderLeft: "1px solid rgba(0,0,0,0.06)" }}>
              <Button
            ...
            <Box sx={{ flex: 1, display: "flex", justifyContent: "center" }}>
              <Button
                ...
                sx={{ p: 0, minWidth: "auto", color: red1 || "#ff0000", fontWeight: 500, fontSize: "14px" }}
              >
                حذف
              </Button>
            </Box>
